...
#Set title of legend  
  labs(fill = "Status of territory as of summer 1941",
       ...
       caption = "Map data principally from Natural Earth, selected from various datasets; I used other maps for reference including those of André Ourednik; for occupied China, I relied on Greg Huff, _World War II and Southeast Asia._ Divergent color scale from CARTOcolors.")
```