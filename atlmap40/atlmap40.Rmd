...
#Set title of legend  
  labs(fill = "Status of territory as of summer 1940",
       caption = "Labels show names and locations of U.S. bases acquired from Britain in destroyers-for-bases deal. Map data principally from Natural Earth, selected from various datasets; I used other maps for reference including those of André Ourednik and Michael de Groot, as well as the Rand-McNally map of Africa in 1939 from the David Rumsey Map Collection. Names of bases<br>from _Air Corps News Letter_; locations from Robert J. Cressman, _Official Chronology of the U.S. Navy in World War II._ Divergent color scale from CARTOcolors.",
