...
#Set title of legend  
  labs(fill = "Status of territory as of summer 1940",
       ...
       caption = "Map data principally from Natural Earth, selected from various datasets; I used other maps for reference including those of André Ourednik and Michael de Groot, as well as the Rand-McNally map of Africa in 1939 from the David Rumsey Map Collection. Names of bases from _Air Corps News Letter_; locations from<br>Robert J. Cressman, _Official Chronology of the U.S. Navy in World War II._ Divergent color scale from CARTOcolors. Made using R with ggplot and sf, as well as some use of QGIS. With gratitude especially to Kieran Healy.",
